...
public class ManipuladorImagem {
    ...
    public static BufferedImage setImagemDimensao(String caminhoImg, Integer imgLargura, Integer imgAltura) {
        ...
        try {
            ...
            Logger.getLogger(ManipuladorImagem.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static byte[] getImgBytes(BufferedImage image) {
        ...
        try {
            ...
            System.err.println("Poblema ao processar as imagens!");
        }
    ...
    public static void exibirImagemLabel(byte[] imagem, javax.swing.JLabel label) {
        ...
        if (imagem != null) {
            ...
            try {
                BufferedImage bImagem = ImageIO.read(input);
                label.setIcon(new ImageIcon(bImagem));
            } catch (IOException ex) {
            }
        } else {
            label.setIcon(null);
