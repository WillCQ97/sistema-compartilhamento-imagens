...
public class EfetuarConfiguracaoView extends javax.swing.JFrame {

    public EfetuarConfiguracaoView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EfetuarConfiguracaoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EfetuarConfiguracaoView().setVisible(true);
            }
        });
    }
